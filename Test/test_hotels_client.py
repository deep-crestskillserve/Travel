...
# coordinates = {"latitude": 48.8584, "longitude": 2.2945} # eiffel tower
# coordinates = {"latitude": 19.1048, "longitude": 72.8267} # Juhu beach
coordinates = {"latitude": 35.6586, "longitude": 139.7454} # tokyo tower, tokyo
async def test_hotels_endpoint():
    ...
    async with httpx.AsyncClient() as client:
        ...
        print("Test case 1...")
        payload = {**coordinates, "radius": 5.0}
        resp = await client.post(base_url, json=payload, headers=headers)
        await save_and_print_response(output_dir, "test-1-temp.json", resp)
